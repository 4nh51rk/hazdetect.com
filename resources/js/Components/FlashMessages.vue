<template>
    <div>
        <div
            ...
            class="mt-2 flex items-center justify-between bg-green-500 rounded max-w-3xl"
        >
            <div class="flex items-center">
                ...
                <div class="py-2 text-white text-sm font-medium">{{ $page.props.flash.success }}</div>
            </div>
        ...
        <div
            ...
            class="mt-2 flex items-center justify-between bg-red-400 rounded max-w-3xl"
        >
            <div class="flex items-center">
                <svg
                    class="ml-4 mr-2 flex-shrink-0 w-4 h-4 fill-white"
                ...
                <div
                    ...
                    class="py-2 text-white text-sm font-medium"
